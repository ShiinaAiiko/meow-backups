...
export const appApi = () => {
  return {
    ...
    async updateSystemConfig(
      ...
      const { apiNames } = api
      const p = {
        language: params.language || app.systemConfig.language || 'system',
        lang: params.lang || app.systemConfig.lang || 'en-US',
        appearance:
          params.appearance || app.systemConfig.appearance || 'system',
