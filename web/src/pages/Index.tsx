	...
	const GetStartTime = () => {
		const [timestamp, setTimestamp] = useState(
			Math.floor(new Date().getTime() / 1000) -
				Number(app.systemConfig?.startTime)
		)
		useEffect(() => {
			setInterval(() => {
				setTimestamp(
															...
															style={
                                {
                                  ...
                                  whiteSpace: "nowrap"
											...
											<div className='item-main'>
												...
												<div className='item-m-subitem'>
													<div className='item-m-s-name'>{t('localPath')}</div>
													<div
														title={v.path || ''}
														className={
															'item-m-s-value  ' +
												...
												<div className='item-m-subitem'>
													<div className='item-m-s-name'>{t('backupPath')}</div>
													<div
														title={v.backupPath || ''}
												...
												<div className='item-m-subitem'>
													<div className='item-m-s-name'>{t('localState')}</div>
												...
												<div className='item-m-subitem'>
													...
													<div className='item-m-s-value'>
														{byteConvert(
															(Number(v.maximumStorageSize) || 0) * 1024 * 1024
														)}{' '}
														·{' '}
														{v.deleteOldDataWhenSizeExceeds
					...
					<div className='ip-r-current-device'>
						<div className='ip-r-cd-item'>
							...
							<div className='ip-r-cd-i-value'>
								...
								<saki-icon type='Folder'></saki-icon>
								<span>
									{Number(app.appSummaryInfo?.localFolderStatus?.folders) || 0}
								</span>
								<saki-icon type='CloudStorage'></saki-icon>
								<span>
									{byteConvert(
						...
						<div className='ip-r-cd-item'>
							...
							<div className='ip-r-cd-i-value'>
								...
								<saki-icon type='Folder'></saki-icon>
								<span>
									{Number(app.appSummaryInfo?.backupFolderStatus?.folders) || 0}
								</span>
								<saki-icon type='CloudStorage'></saki-icon>
								<span>
									{byteConvert(
