...
import (
	...
	"github.com/ShiinaAiiko/meow-backups/routers/socketioRouter"
	socketioMiddleware "github.com/ShiinaAiiko/meow-backups/services/middleware/socket.io"
...
func InitSocketIO() {
	...
	log.Info(conf.SocketIO)
	log.Info(conf.SocketIO.Server)
	// 处理中间件
	...
	conf.SocketIO.Use(socketioMiddleware.Params())
...
// 	"github.com/ShiinaAiiko/meow-backups/services/gin_service"
// 	socketioMiddleware "github.com/ShiinaAiiko/meow-backups/services/middleware/socket.io"
